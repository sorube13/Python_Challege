...
# 	index = text.index(c)
# 	if index > 2:
# 		if (text[index-3].isupper() and text[index-2].isupper() and text[index-1].isupper() and
# 			text[index+1].isupper() and text[index+2].isupper() and text[index+3].isupper() and
# 			text[index].islower()):
# 			result+=str(c)
	# import pdb
	# pdb.set_trace()

result += str(re.findall("[^A-Z]+[A-Z]{3}([a-z])[A-Z]{3}[^A-Z]+", text))
